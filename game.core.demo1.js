	...
	var _game = {
		...
		player: {
			...
			checkGameOver: function () {
                ...
                // This is the thing where you fucking change the map, i listed it so i wont fucking forget where i am adding shit to the map
		level: {
			// Methods
			create: function() {
				...
				// Add a floor
				_cannon.createRigidBody({
					shape: new CANNON.Box(new CANNON.Vec3(400, 400, 20)),
					mass: 0,
					position: new CANNON.Vec3(800, 0, -floorHeight),
					meshMaterial: new THREE.MeshLambertMaterial({ color: window.game.static.colors.green }),
					physicsMaterial: _cannon.solidMaterial
				});
				...
				// Add a Object
				_cannon.createRigidBody({
					shape: new CANNON.Box(new CANNON.Vec3(100, 20, 20)),
					mass: 0,
					position: new CANNON.Vec3(800, 100, 20),
				...
				_cannon.createRigidBody({
					shape: new CANNON.Box(new CANNON.Vec3(100, 20, 20)),
					mass: 0,
					position: new CANNON.Vec3(800, 100, 60),
					meshMaterial: new THREE.MeshLambertMaterial({ color: window.game.static.colors.red }),
					physicsMaterial: _cannon.solidMaterial
				});
				...
				_cannon.createRigidBody({
					...
					mass: 0,
					position: new CANNON.Vec3(-500, 0, -20),
					meshMaterial: new THREE.MeshLambertMaterial({ color: window.game.static.colors.green }),
					physicsMaterial: _cannon.solidMaterial
				});
				...
				_cannon.createRigidBody({
					shape: new CANNON.Box(new CANNON.Vec3(100, 100, 20)),
					mass: 0,
					position: new CANNON.Vec3(-850, 0, -20),
					meshMaterial: new THREE.MeshLambertMaterial({ color: window.game.static.colors.green }),
					physicsMaterial: _cannon.solidMaterial
				});
				...
				_cannon.createRigidBody({
					shape: new CANNON.Box(new CANNON.Vec3(100, 100, 20)),
					mass: 0,
					position: new CANNON.Vec3(-850, 350, -20),
					meshMaterial: new THREE.MeshLambertMaterial({ color: window.game.static.colors.green }),
					physicsMaterial: _cannon.solidMaterial
				});
				...
				_cannon.createRigidBody({
					shape: new CANNON.Box(new CANNON.Vec3(100, 100, 20)),
					mass: 0,
					position: new CANNON.Vec3(-850, 700, -20),
					meshMaterial: new THREE.MeshLambertMaterial({ color: window.game.static.colors.green }),
					physicsMaterial: _cannon.solidMaterial
				});
				...
				_cannon.createRigidBody({
					shape: new CANNON.Box(new CANNON.Vec3(100, 100, 20)),
					mass: 0,
					position: new CANNON.Vec3(-500, 700, -20),
					meshMaterial: new THREE.MeshLambertMaterial({ color: window.game.static.colors.green }),
					physicsMaterial: _cannon.solidMaterial
				});
				...
				_cannon.createRigidBody({
					shape: new CANNON.Box(new CANNON.Vec3(100, 100, 20)),
					mass: 0,
					position: new CANNON.Vec3(-150, 700, -20),
					meshMaterial: new THREE.MeshLambertMaterial({ color: window.game.static.colors.green }),
					physicsMaterial: _cannon.solidMaterial
				});

				_cannon.createRigidBody({
					shape: new CANNON.Box(new CANNON.Vec3(100, 50, 20)),
					mass: 0,
					position: new CANNON.Vec3(-150, 450, -20),
					meshMaterial: new THREE.MeshLambertMaterial({ color: window.game.static.colors.green }),
					physicsMaterial: _cannon.solidMaterial
				});
